...
| :--- | :--- |
| **Design & Experiência** | `Figma` • `UI/UX Design` • `Wireframing` • `Prototipagem` |
| **Desenvolvimento** | `HTML5` • `CSS3` • `JavaScript (ES6+)` |
| **Estilização & Estrutura** | `Flexbox / Grid` • `Responsividade` • `Animações CSS`  `React-Native`|
...
<p align="left">
  <a href="https://www.linkedin.com/in/leonardo-ara%C3%BAjo-1522a0330/target="_blank">
    <img src="https://img.shields.io/badge/-LinkedIn-blue?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a> 
  <a href="mailto:leox.araujo0@gmail.com" target="_blank">
